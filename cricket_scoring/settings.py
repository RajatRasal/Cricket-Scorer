"""
Django settings for cricket_scoring project.
...
SECRET_KEY = 'yroj8a=7+v$=xf6bg8!^qs8x1799#=i)qnl5-zs!@nl*q8)egs'
...
ROOT_URLCONF = 'cricket_scoring.urls'
...
WSGI_APPLICATION = 'cricket_scoring.wsgi.application'
